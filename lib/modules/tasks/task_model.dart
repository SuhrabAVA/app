...
class TaskModel {
  ...
  /// Преобразует задачу в Map для сохранения в Supabase. Комментарии
  ...
  /// Создаёт модель задачи из Supabase. При чтении комментариев из базы
  /// используется Map, где ключи — это идентификаторы Supabase. Комментарии
