...
/// Показывать ли плавающую кнопку ошибок («жучка») поверх приложения.
///
/// Выключена на всех платформах: сотрудники видели её в цеху и на ПК, а
/// пользы от неё на рабочем месте нет. Перехват ошибок, запись в
/// errors_log.txt и выгрузка журнала на сервер (ErrorLogUploader)
/// продолжают работать — отчёты приходят как раньше.
const bool kShowErrorOverlay = false;
